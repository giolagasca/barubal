...
<table id="content"
	...
	<tr style="height: 60px;">
		<td><img src="./images/acn_logo.PNG" alt="Banner Image"></td>
		<td align=right>
...
<center>
			...
			<center>
			<font size="5" style="font-family: Calibri, Garamond, Serif; color: red;">Invalid Start Date format at row 10.</font>
			</center>
			<br><br>
        <hr>
        <hr>
			...
			<td colspan=125><img src="./images/Computer_training2_jpg.jpg" height=200 width=200></td>
				<td valign="Center">
					...
					<!-- 	<tr><td font size="15" style="font-family: Calibri, Garamond, Serif; color: #D2691E;">Request Successfuly Processed!!!</td></tr> -->
						<tr><td><a href="./index.jsp">Process another Request</a></td></tr>
					</table>
				</td>
